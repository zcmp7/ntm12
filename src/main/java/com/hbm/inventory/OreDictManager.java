...
public class OreDictManager {
	...
	public static void registerOres() {
		...
		CO			.nugget(fragment_cobalt)	.nugget(nugget_cobalt)	    .ingot(ingot_cobalt)				.dust(powder_cobalt)			.dustSmall(powder_cobalt_tiny)	.block(block_cobalt)		.ore(ore_cobalt, ore_nether_cobalt);
		 ...
		 * DUST AND GEM ORES
		 */
		S																				.dust(sulfur)			.block(block_sulfur)	.ore(ore_sulfur, ore_nether_sulfur, basalt_sulfur, ore_meteor_sulfur) /*DictFrame.fromOne(stone_resource, EnumStoneType.SULFUR))*/;
