...
public class CentrifugeRecipes {
	...
	public static void register() {
		...
		recipes.put(new ComparableStack(ModItems.crystal_lapis), new ItemStack[] { new ItemStack(ModItems.powder_lapis, 8), new ItemStack(ModItems.powder_lapis, 8), new ItemStack(ModItems.powder_cobalt, 1), new ItemStack(Blocks.GRAVEL, 1) });
		...
		recipes.put(new ComparableStack(ModItems.crystal_uranium), new ItemStack[] { new ItemStack(ModItems.powder_uranium, 2), new ItemStack(ModItems.powder_uranium, 2), new ItemStack(ModItems.powder_polonium, 2), new ItemStack(ModItems.powder_lithium_tiny, 1) });
