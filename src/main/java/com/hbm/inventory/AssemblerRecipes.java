...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.fuel_tank_small, 1), new AStack[] { new NbtComparableStack(ItemFluidCanister.getFullCanister(ModForgeFluids.kerosene, 4)), new OreDictStack(TI.plate(), 6), new OreDictStack(STEEL.plate(), 2), }, 100);
		...
		makeRecipe(new ComparableStack(ModBlocks.fwatz_core, 1), new AStack[] { new ComparableStack(ModBlocks.fwatz_computer, 8), new ComparableStack(ModItems.sphere_steel, 1), new ComparableStack(ModItems.sat_head_resonator, 1), new ComparableStack(ModItems.pellet_coolant, 4), new ComparableStack(ModItems.sat_head_laser, 2), new ComparableStack(ModItems.upgrade_overdrive_3, 2), new ComparableStack(ModItems.fusion_shield_chlorophyte, 1), new OreDictStack(CMB.dust(), 16), }, 450);
		...
		makeRecipe(new ComparableStack(ModItems.schrabidium_hammer, 1), new AStack[] { new OreDictStack(SA326.block(), 15), new OreDictStack(POLYMER.ingot(), 128), new ComparableStack(Items.NETHER_STAR, 3), new ComparableStack(ModItems.fragment_meteorite, 512), }, 1000);
