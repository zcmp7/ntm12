...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.plate_mixed, 6), new AStack[] { new OreDictStack(ALLOY.plate(), 2), new OreDictStack(OreDictManager.getReflector(), 2), new OreDictStack(CMB.plate(), 1), new OreDictStack("plateLead", 4), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.centrifuge_tower, 1), new AStack[] { new ComparableStack(ModItems.centrifuge_element, 4), new OreDictStack(STEEL.plate(), 4), new ComparableStack(ModItems.wire_red_copper, 6), new OreDictStack("dustLapis", 2), new OreDictStack(POLYMER.ingot(), 2), }, 150);
		...
		makeRecipe(new ComparableStack(ModItems.magnet_circular, 1), new AStack[] { new ComparableStack(ModBlocks.fusion_conductor, 5), new OreDictStack(STEEL.ingot(), 4), new OreDictStack(ALLOY.plate(), 6), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.reactor_core, 1), new AStack[] { new OreDictStack(PB.ingot(), 8), new OreDictStack("ingotBeryllium", 6), new OreDictStack(STEEL.plate(), 16), new OreDictStack(OreDictManager.getReflector(), 8), new ComparableStack(ModItems.ingot_fiberglass, 2) }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.thermo_unit_empty, 1), new AStack[] { new ComparableStack(ModItems.coil_copper_torus, 3), new OreDictStack(STEEL.ingot(), 3), new OreDictStack("plateTitanium", 6), new ComparableStack(ModItems.plate_polymer, 12), new ComparableStack(ModItems.ingot_bromine, 2), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.drill_titanium, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 2), new ComparableStack(ModItems.ingot_dura_steel, 2), new ComparableStack(ModItems.bolt_dura_steel, 2), new OreDictStack("plateTitanium", 6), }, 100);
		makeRecipe(new ComparableStack(ModItems.telepad, 1), new AStack[] { new OreDictStack(POLYMER.ingot(), 12), new ComparableStack(ModItems.plate_schrabidium, 2), new OreDictStack(CMB.plate(), 4), new OreDictStack(STEEL.plate(), 2), new ComparableStack(ModItems.wire_gold, 6), new ComparableStack(ModItems.circuit_schrabidium, 1), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.warhead_generic_small, 1), new AStack[] { new OreDictStack("plateTitanium", 5), new OreDictStack(STEEL.plate(), 3), new ComparableStack(Blocks.TNT, 2), }, 100);
		makeRecipe(new ComparableStack(ModItems.warhead_generic_medium, 1), new AStack[] { new OreDictStack("plateTitanium", 8), new OreDictStack(STEEL.plate(), 5), new ComparableStack(Blocks.TNT, 4), }, 150);
		makeRecipe(new ComparableStack(ModItems.warhead_generic_large, 1), new AStack[] { new OreDictStack("plateTitanium", 15), new OreDictStack(STEEL.plate(), 8), new ComparableStack(Blocks.TNT, 8), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.warhead_nuclear, 1), new AStack[] { new ComparableStack(ModItems.boy_shielding, 1), new ComparableStack(ModItems.boy_target, 1), new ComparableStack(ModItems.boy_bullet, 1), new OreDictStack("plateTitanium", 20), new OreDictStack(STEEL.plate(), 12), }, 300);
		makeRecipe(new ComparableStack(ModItems.warhead_mirvlet, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 5), new OreDictStack(STEEL.plate(), 18), new ComparableStack(ModItems.ingot_pu239, 1), new ComparableStack(Blocks.TNT, 2), }, 250);
		makeRecipe(new ComparableStack(ModItems.warhead_mirv, 1), new AStack[] { new OreDictStack("ingotTungsten", 18), new OreDictStack("plateTitanium", 20), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModBlocks.det_nuke, 2), new ComparableStack(ModBlocks.det_charge, 8), new OreDictStack(OreDictManager.getReflector(), 6), new ComparableStack(ModItems.mike_core, 1), new ComparableStack(ModItems.mike_deut, 1), }, 500);
		makeRecipe(new ComparableStack(ModItems.warhead_thermo_endo, 1), new AStack[] { new ComparableStack(ModBlocks.therm_endo, 2), new OreDictStack("plateTitanium", 12), new OreDictStack(STEEL.plate(), 6), }, 300);
		makeRecipe(new ComparableStack(ModItems.warhead_thermo_exo, 1), new AStack[] { new ComparableStack(ModBlocks.therm_exo, 2), new OreDictStack("plateTitanium", 12), new OreDictStack(STEEL.plate(), 6), }, 300);
		makeRecipe(new ComparableStack(ModItems.fuel_tank_small, 1), new AStack[] { new NbtComparableStack(ItemFluidCanister.getFullCanister(ModForgeFluids.kerosene, 4)), new OreDictStack("plateTitanium", 6), new OreDictStack(STEEL.plate(), 2), }, 100);
		makeRecipe(new ComparableStack(ModItems.fuel_tank_medium, 1), new AStack[] { new ComparableStack(ModItems.fuel_tank_small, 3), new OreDictStack("plateTitanium", 4), new OreDictStack(STEEL.plate(), 2), }, 150);
		makeRecipe(new ComparableStack(ModItems.fuel_tank_large, 1), new AStack[] { new ComparableStack(ModItems.fuel_tank_medium, 3), new OreDictStack("plateTitanium", 4), new OreDictStack(STEEL.plate(), 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.sat_head_laser, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 12), new OreDictStack("ingotTungsten", 16), new OreDictStack(POLYMER.ingot(), 6), new ComparableStack(ModItems.plate_polymer, 16), new ComparableStack(ModItems.board_copper, 24), new ComparableStack(ModItems.circuit_targeting_tier5, 2), new ComparableStack(Items.REDSTONE, 16), new ComparableStack(Items.DIAMOND, 5), new ComparableStack(Blocks.GLASS_PANE, 16), }, 450);
		makeRecipe(new ComparableStack(ModItems.sat_head_resonator, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 32), new OreDictStack(POLYMER.ingot(), 48), new ComparableStack(ModItems.plate_polymer, 8), new ComparableStack(ModItems.crystal_xen, 1), new ComparableStack(ModItems.ingot_starmetal, 7), new ComparableStack(ModItems.circuit_targeting_tier5, 6), new ComparableStack(ModItems.circuit_targeting_tier6, 2), }, 1000);
		...
		makeRecipe(new ComparableStack(ModItems.australium_iii, 1), new AStack[] { new ComparableStack(ModItems.rod_australium, 1), new OreDictStack(STEEL.ingot(), 1), new OreDictStack(STEEL.plate(), 6), new OreDictStack("plateCopper", 2), new ComparableStack(ModItems.wire_copper, 6), }, 150);
		...
		makeRecipe(new ComparableStack(ModItems.pellet_schrabidium, 1), new AStack[] { new OreDictStack(SA326.ingot(), 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_hes, 1), new AStack[] { new ComparableStack(ModItems.ingot_hes, 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_mes, 1), new AStack[] { new ComparableStack(ModItems.ingot_schrabidium_fuel, 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_les, 1), new AStack[] { new ComparableStack(ModItems.ingot_les, 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_beryllium, 1), new AStack[] { new ComparableStack(ModItems.ingot_beryllium, 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_neptunium, 1), new AStack[] { new ComparableStack(ModItems.ingot_neptunium, 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_lead, 1), new AStack[] { new OreDictStack(PB.ingot(), 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_advanced, 1), new AStack[] { new OreDictStack("ingotDesh", 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.upgrade_template, 1), new AStack[] { new OreDictStack(STEEL.plate(), 1), new OreDictStack("plateIron", 4), new OreDictStack("plateCopper", 2), new ComparableStack(ModItems.wire_copper, 6), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_effect_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(DURA.dust(), 4), new ComparableStack(ModItems.powder_steel, 6), new ComparableStack(ModItems.wire_red_copper, 4), }, 200);
		makeRecipe(new ComparableStack(ModItems.upgrade_effect_2, 1), new AStack[] { new ComparableStack(ModItems.upgrade_effect_1, 1), new OreDictStack(DURA.dust(), 2), new ComparableStack(ModItems.powder_steel, 4), new ComparableStack(ModItems.circuit_red_copper, 4), new ComparableStack(ModItems.wire_red_copper, 4), new OreDictStack(POLYMER.ingot(), 2), }, 300);
		makeRecipe(new ComparableStack(ModItems.upgrade_effect_3, 1), new AStack[] { new ComparableStack(ModItems.upgrade_effect_2, 1), new OreDictStack(DURA.dust(), 2), new ComparableStack(ModItems.powder_steel, 6), new OreDictStack("ingotDesh", 4), }, 500);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_overdrive_2, 1), new AStack[] { new ComparableStack(ModItems.upgrade_overdrive_1, 1), new ComparableStack(ModItems.upgrade_afterburn_1, 1), new ComparableStack(ModItems.upgrade_speed_3, 2), new ComparableStack(ModItems.upgrade_effect_3, 2), new OreDictStack(BIGMT.ingot(), 12), new ComparableStack(ModItems.powder_nitan_mix, 16), new ComparableStack(ModItems.crystal_starmetal, 6), new ComparableStack(ModItems.circuit_schrabidium, 6), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.thermo_element, 1), new AStack[] { new OreDictStack(STEEL.plate(), 3), new OreDictStack("plateIron", 1), new OreDictStack("plateCopper", 2), new ComparableStack(ModItems.wire_red_copper, 2), new ComparableStack(ModItems.wire_aluminium, 2), new OreDictStack("dustNetherQuartz", 4), }, 150);
		//makeRecipe(new ComparableStack(ModItems.limiter, 1), new AStack[] {new OreDictStack(STEEL.plate(), 3), new OreDictStack("plateIron", 1), new ComparableStack(ModItems.circuit_copper, 2), new ComparableStack(ModItems.wire_copper, 4), },150);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_centrifuge, 1), new AStack[] { new ComparableStack(ModItems.centrifuge_tower, 1), new OreDictStack(STEEL.ingot(), 4), new OreDictStack("ingotIron", 4), new OreDictStack(STEEL.plate(), 2), new OreDictStack("plateCopper", 2), new ComparableStack(ModItems.wire_red_copper, 8), }, 250);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_reactor, 1), new AStack[] { new ComparableStack(ModItems.reactor_core, 1), new OreDictStack(STEEL.ingot(), 12), new OreDictStack("plateLead", 16), new ComparableStack(ModBlocks.reinforced_glass, 4), new OreDictStack(ASBESTOS.ingot(), 4) }, 150);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_diesel, 1), new AStack[] { new ComparableStack(ModItems.hull_small_steel, 4), new ComparableStack(Blocks.PISTON, 4), new OreDictStack(STEEL.ingot(), 6), new OreDictStack("ingotMingrade", 2), new OreDictStack("plateCopper", 4), new ComparableStack(ModItems.wire_red_copper, 6), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_battery, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 4), new OreDictStack("dustSulfur", 12), new OreDictStack("dustLead", 12), new OreDictStack("ingotMingrade", 2), new ComparableStack(ModItems.wire_red_copper, 4), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.machine_lithium_battery, 1), new AStack[] { new OreDictStack(POLYMER.ingot(), 4), new OreDictStack("dustCobalt", 12), new OreDictStack("dustLithium", 12), new OreDictStack(ALLOY.ingot(), 2), new ComparableStack(ModItems.wire_red_copper, 4), }, 400);
		makeRecipe(new ComparableStack(ModBlocks.machine_schrabidium_battery, 1), new AStack[] { new OreDictStack("ingotDesh", 4), new ComparableStack(ModItems.powder_neptunium, 12), new ComparableStack(ModItems.powder_schrabidium, 12), new OreDictStack(SA326.ingot(), 2), new ComparableStack(ModItems.wire_schrabidium, 4), }, 800);
		...
		makeRecipe(new ComparableStack(ModBlocks.reactor_element, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 2), new OreDictStack(OreDictManager.getReflector(), 4), new OreDictStack("plateLead", 2), new ComparableStack(ModItems.rod_empty, 8), }, 150);
		...
		makeRecipe(new ComparableStack(ModBlocks.reactor_conductor, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 4), new OreDictStack("plateCopper", 12), new ComparableStack(ModItems.wire_tungsten, 4), }, 130);
		...
		makeRecipe(new ComparableStack(ModBlocks.fusion_conductor, 3), new AStack[] {new ComparableStack(ModItems.ingot_neodymium) , new OreDictStack(STEEL.ingot(), 4), new ComparableStack(ModItems.coil_advanced_alloy, 10), }, 150);
		makeRecipe(new ComparableStack(ModBlocks.fusion_center, 1), new AStack[] { new OreDictStack("ingotTungsten", 4), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.wire_advanced_alloy, 24), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.watz_element, 1), new AStack[] { new OreDictStack("ingotTungsten", 4), new OreDictStack(ALLOY.plate(), 4), new ComparableStack(ModItems.rod_empty, 2), new ComparableStack(ModItems.wire_magnetized_tungsten, 2), new ComparableStack(ModItems.wire_advanced_alloy, 4), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.watz_control, 1), new AStack[] { new OreDictStack("ingotTungsten", 4), new OreDictStack(ALLOY.ingot(), 4), new OreDictStack(PB.ingot(), 2), new ComparableStack(ModItems.wire_magnetized_tungsten, 4), new ComparableStack(ModItems.wire_advanced_alloy, 2), }, 250);
		makeRecipe(new ComparableStack(ModBlocks.watz_cooler, 1), new AStack[] { new OreDictStack("ingotTungsten", 2), new OreDictStack(STEEL.ingot(), 2), new OreDictStack("dustSaltpeter", 4), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.watz_end, 1), new AStack[] { new OreDictStack("ingotTungsten", 2), new OreDictStack(PB.ingot(), 2), new OreDictStack(STEEL.ingot(), 3), }, 150);
		...
		makeRecipe(new ComparableStack(ModBlocks.turret_light, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 6), new ComparableStack(ModItems.pipes_steel, 2), new OreDictStack("ingotMingrade", 2), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.circuit_targeting_tier2, 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.turret_cheapo, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 4), new OreDictStack("plateIron", 4), new ComparableStack(ModItems.pipes_steel, 3), new ComparableStack(ModItems.motor, 3), new ComparableStack(ModItems.circuit_targeting_tier1, 4), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.gun_defabricator, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 2), new OreDictStack(POLYMER.ingot(), 8), new OreDictStack("plateIron", 5), new ComparableStack(ModItems.mechanism_special, 3), new ComparableStack(Items.DIAMOND, 1), new ComparableStack(ModItems.plate_dalekanium, 3), }, 200);
		makeRecipe(new ComparableStack(ModItems.gun_fatman_ammo, 1), new AStack[] { new OreDictStack(STEEL.plate(), 3), new OreDictStack("plateIron", 1), new ComparableStack(ModItems.nugget_pu239, 3), }, 40);
		makeRecipe(new ComparableStack(ModItems.gun_mirv_ammo, 1), new AStack[] { new OreDictStack(STEEL.plate(), 20), new OreDictStack("plateIron", 10), new ComparableStack(ModItems.nugget_pu239, 24), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_flare, 1), new AStack[] { new ComparableStack(ModItems.grenade_generic, 1), new ComparableStack(Items.GLOWSTONE_DUST, 1), new OreDictStack("plateAluminum", 2), new ComparableStack(ModItems.ingot_caesium, 1), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_pulse, 4), new AStack[] { new OreDictStack(STEEL.plate(), 1), new OreDictStack("plateIron", 3), new ComparableStack(ModItems.wire_red_copper, 6), new ComparableStack(Items.DIAMOND, 1), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_tau, 2), new AStack[] { new OreDictStack("plateLead", 3), new OreDictStack(ALLOY.plate(), 1), new ComparableStack(ModItems.coil_advanced_torus, 1), new ComparableStack(ModItems.gun_xvl1456_ammo, 1), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_nuclear, 1), new AStack[] { new OreDictStack("plateIron", 1), new OreDictStack(STEEL.plate(), 1), new ComparableStack(ModItems.nugget_pu239, 2), new ComparableStack(ModItems.wire_red_copper, 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_solinium, 1), new AStack[] { new OreDictStack(CMB.plate(), 6), new ComparableStack(ModItems.ingot_unobtainium, 3),  new ComparableStack(ModItems.coil_gold, 12), new ComparableStack(ModItems.solinium_propellant, 1), new ComparableStack(ModItems.solinium_igniter, 1), new ComparableStack(ModItems.solinium_core, 1), }, 400);
		...
		makeRecipe(new ComparableStack(ModItems.gadget_explosive, 1), new AStack[] { new ComparableStack(Blocks.TNT, 3), new OreDictStack(STEEL.plate(), 2), new OreDictStack("plateAluminum", 4), new ComparableStack(ModItems.wire_gold, 3), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.boy_igniter, 1), new AStack[] { new OreDictStack("plateAluminum", 6), new OreDictStack(STEEL.plate(), 1), new ComparableStack(ModItems.circuit_red_copper, 1), new ComparableStack(ModItems.wire_red_copper, 3), }, 100);
		makeRecipe(new ComparableStack(ModItems.man_explosive, 1), new AStack[] { new ComparableStack(Blocks.TNT, 2), new ComparableStack(ModItems.ingot_semtex, 3), new OreDictStack(STEEL.plate(), 2), new OreDictStack("plateTitanium", 4), new ComparableStack(ModItems.wire_red_copper, 3), }, 150);
		...
		makeRecipe(new ComparableStack(ModItems.mike_core, 1), new AStack[] { new ComparableStack(ModItems.nugget_u238, 24), new OreDictStack(PB.ingot(), 6), }, 250);
		makeRecipe(new ComparableStack(ModItems.mike_deut, 1), new AStack[] { new OreDictStack("plateIron", 12), new OreDictStack(STEEL.plate(), 16), new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.deuterium, 10)), }, 250);
		...
		makeRecipe(new ComparableStack(ModItems.fleija_propellant, 1), new AStack[] { new ComparableStack(Blocks.TNT, 3), new ComparableStack(ModItems.plate_schrabidium, 8), new ComparableStack(ModItems.ingot_tennessine, 2), }, 400);
		...
		makeRecipe(new ComparableStack(ModItems.solinium_core, 1), new AStack[] { new ComparableStack(ModItems.ingot_solinium, 3), new ComparableStack(ModItems.nugget_euphemium, 4), new ComparableStack(ModItems.ingot_tennessine, 5), }, 400);
		...
		makeRecipe(new ComparableStack(ModItems.schrabidium_hammer, 1), new AStack[] { new ComparableStack(ModBlocks.block_schrabidium, 15), new OreDictStack(POLYMER.ingot(), 128), new ComparableStack(Items.NETHER_STAR, 3), new ComparableStack(ModItems.fragment_meteorite, 512), }, 1000);
		...
		makeRecipe(new ComparableStack(ModItems.mp_thruster_10_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 1), new ComparableStack(ModItems.pipes_steel, 1), new OreDictStack("ingotTungsten", 4), new OreDictStack(STEEL.plate(), 4), }, 100);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_10_solid, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 1), new ComparableStack(ModItems.coil_tungsten, 1), new ComparableStack(ModItems.ingot_dura_steel, 4), new OreDictStack(STEEL.plate(), 4), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.pipes_steel, 4), new OreDictStack("ingotTungsten", 8), new OreDictStack(STEEL.plate(), 6), new OreDictStack("ingotDesh", 4), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_kerosene_dual, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.pipes_steel, 2), new OreDictStack("ingotTungsten", 4), new OreDictStack(STEEL.plate(), 6), new OreDictStack("ingotDesh", 1), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_kerosene_triple, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.pipes_steel, 3), new OreDictStack("ingotTungsten", 6), new OreDictStack(STEEL.plate(), 6), new OreDictStack("ingotDesh", 2), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_solid, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.ingot_dura_steel, 6), new ComparableStack(ModItems.coil_tungsten, 3), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_solid_hexdecuple, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.ingot_dura_steel, 12), new ComparableStack(ModItems.coil_tungsten, 6), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_hydrogen, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.pipes_steel, 4), new OreDictStack("ingotTungsten", 8), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.tank_steel, 1), new OreDictStack("ingotDesh", 4), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_hydrogen_dual, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.pipes_steel, 2), new OreDictStack("ingotTungsten", 4), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.tank_steel, 1), new OreDictStack("ingotDesh", 1), }, 500);
		...
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_balefire, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.plate_polymer, 16), new ComparableStack(ModBlocks.reactor_element, 2), new OreDictStack("ingotDesh", 16), new OreDictStack(BIGMT.plate(), 24), new ComparableStack(ModItems.board_copper, 4), new ComparableStack(ModItems.ingot_uranium_fuel, 8), new ComparableStack(ModItems.pipes_steel, 2), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_15_balefire_large, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.plate_polymer, 16), new ComparableStack(ModBlocks.reactor_element, 2), new OreDictStack("ingotDesh", 24), new OreDictStack(BIGMT.plate(), 32), new ComparableStack(ModItems.board_copper, 4), new ComparableStack(ModItems.ingot_uranium_fuel, 8), new ComparableStack(ModItems.pipes_steel, 2), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModItems.pipes_steel, 8), new OreDictStack("ingotTungsten", 16), new OreDictStack(STEEL.plate(), 12), new OreDictStack("ingotDesh", 8), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_kerosene_dual, 1), new AStack[] { new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModItems.pipes_steel, 4), new OreDictStack("ingotTungsten", 8), new OreDictStack(STEEL.plate(), 6), new OreDictStack("ingotDesh", 4), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_kerosene_triple, 1), new AStack[] { new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModItems.pipes_steel, 6), new OreDictStack("ingotTungsten", 12), new OreDictStack(STEEL.plate(), 8), new OreDictStack("ingotDesh", 6), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_solid, 1), new AStack[] { new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModItems.coil_tungsten, 8), new ComparableStack(ModItems.ingot_dura_steel, 16), new OreDictStack(STEEL.plate(), 12), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_solid_multi, 1), new AStack[] { new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModItems.coil_tungsten, 12), new ComparableStack(ModItems.ingot_dura_steel, 18), new OreDictStack(STEEL.plate(), 12), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_thruster_20_solid_multier, 1), new AStack[] { new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModItems.coil_tungsten, 16), new ComparableStack(ModItems.ingot_dura_steel, 20), new OreDictStack(STEEL.plate(), 12), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_fuselage_10_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 2), new ComparableStack(ModBlocks.steel_scaffold, 3), new OreDictStack("plateTitanium", 12), new OreDictStack(STEEL.plate(), 3), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.mp_fuselage_10_long_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 2), new ComparableStack(ModBlocks.steel_scaffold, 6), new OreDictStack("plateTitanium", 24), new OreDictStack(STEEL.plate(), 6), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.mp_fuselage_10_15_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 1), new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModBlocks.steel_scaffold, 9), new OreDictStack("plateTitanium", 36), new OreDictStack(STEEL.plate(), 9), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.mp_fuselage_10_15_balefire, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 1), new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModBlocks.steel_scaffold, 9), new OreDictStack("plateTitanium", 36), new OreDictStack(BIGMT.plate(), 9), }, 300);
		makeRecipe(new ComparableStack(ModItems.mp_fuselage_15_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 2), new ComparableStack(ModBlocks.steel_scaffold, 12), new OreDictStack("plateTitanium", 48), new OreDictStack(STEEL.plate(), 12), }, 500);
		...
		makeRecipe(new ComparableStack(ModItems.mp_fuselage_15_balefire, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 2), new ComparableStack(ModBlocks.steel_scaffold, 12), new OreDictStack("plateTitanium", 48), new OreDictStack(BIGMT.plate(), 12), }, 500);
		makeRecipe(new ComparableStack(ModItems.mp_fuselage_15_20_kerosene, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModBlocks.steel_scaffold, 16), new OreDictStack("plateTitanium", 64), new OreDictStack(STEEL.plate(), 16), }, 600);
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_10_nuclear, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 1), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.ingot_pu239, 1), new ComparableStack(Blocks.TNT, 2), new ComparableStack(ModItems.circuit_targeting_tier3, 1), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_15_incendiary, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new OreDictStack(STEEL.plate(), 16), new ComparableStack(ModBlocks.det_charge, 2), new ComparableStack(ModItems.powder_fire, 8), new ComparableStack(ModItems.circuit_targeting_tier3, 1), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_15_mirv, 1), new AStack[] { new ComparableStack(ModItems.seg_15, 1), new OreDictStack("plateTitanium", 16), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModItems.ingot_semtex, 7), new ComparableStack(ModItems.ingot_beryllium, 7), new ComparableStack(ModItems.billet_u238, 7), new ComparableStack(ModItems.nugget_u235, 10), new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.deuterium, 10)),new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.tritium, 10)),new ComparableStack(ModItems.hull_small_steel, 7),new ComparableStack(ModItems.circuit_targeting_tier4,  3), },600);
		...
		makeRecipe(new ComparableStack(ModItems.fusion_shield_desh, 1), new AStack[] { new OreDictStack("blockDesh", 16), new OreDictStack("blockCobalt", 16), new OreDictStack(BIGMT.plate(), 96) }, 600);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_cyclotron, 1), new AStack[] { new ComparableStack(ModBlocks.machine_lithium_battery, 3), new ComparableStack(ModItems.magnet_dee, 6), new ComparableStack(ModItems.magnet_circular, 9), new OreDictStack(STEEL.ingot(), 16), new OreDictStack(STEEL.plate(), 32), new OreDictStack("plateAluminum", 32), new OreDictStack(POLYMER.ingot(), 24), new ComparableStack(ModItems.plate_polymer, 64), new ComparableStack(ModItems.board_copper, 8), new ComparableStack(ModItems.circuit_red_copper, 8), new ComparableStack(ModItems.circuit_gold, 3), }, 600);
		...
		if(!GeneralConfig.enable528) {
			makeRecipe(new ComparableStack(ModBlocks.reactor_element, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 2), new OreDictStack(OreDictManager.getReflector(), 4), new OreDictStack("plateLead", 2), new ComparableStack(ModItems.ingot_zirconium, 2), },150);
			makeRecipe(new ComparableStack(ModBlocks.reactor_control, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 4), new OreDictStack(PB.ingot(), 6), new ComparableStack(ModItems.bolt_tungsten, 6), new ComparableStack(ModItems.motor, 1), },100);
			makeRecipe(new ComparableStack(ModBlocks.reactor_hatch, 1), new AStack[] {new ComparableStack(ModBlocks.brick_concrete, 1), new OreDictStack(STEEL.plate(), 6), },150);
			makeRecipe(new ComparableStack(ModBlocks.reactor_conductor, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 4), new OreDictStack("plateCopper", 12), new ComparableStack(ModItems.wire_tungsten, 4), },130);
			makeRecipe(new ComparableStack(ModBlocks.reactor_computer, 1), new AStack[] {new ComparableStack(ModBlocks.reactor_conductor, 2), new ComparableStack(ModItems.circuit_targeting_tier3, 4), new ComparableStack(ModItems.circuit_gold, 1), },250);
			makeRecipe(new ComparableStack(ModBlocks.machine_radgen, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 8), new OreDictStack(STEEL.plate(), 32), new ComparableStack(ModItems.coil_magnetized_tungsten, 6), new ComparableStack(ModItems.wire_magnetized_tungsten, 24), new ComparableStack(ModItems.circuit_gold, 4), new ComparableStack(ModItems.reactor_core, 3), new ComparableStack(ModItems.ingot_starmetal, 1), new OreDictStack("dyeRed", 1), },400);
			makeRecipe(new ComparableStack(ModBlocks.machine_reactor, 1), new AStack[] {new ComparableStack(ModItems.reactor_core, 1), new OreDictStack(STEEL.ingot(), 12), new OreDictStack("plateLead", 16), new ComparableStack(ModBlocks.reinforced_glass, 4), new OreDictStack(ASBESTOS.ingot(), 4), new ComparableStack(ModItems.ingot_tcalloy, 4)},150);
			makeRecipe(new ComparableStack(ModBlocks.machine_reactor_small, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 6), new OreDictStack(POLYMER.ingot(), 4), new OreDictStack("plateLead", 8), new OreDictStack("plateCopper", 4), new OreDictStack(PB.ingot(), 12), new OreDictStack("ingotMingrade", 6), new ComparableStack(ModItems.circuit_copper, 8), new ComparableStack(ModItems.circuit_red_copper, 4), },300);
		...
		makeRecipe(new ComparableStack(ModItems.missile_inferno, 1), new AStack[] {new ComparableStack(ModItems.warhead_incendiary_large, 1), new ComparableStack(ModItems.fuel_tank_large, 1), new ComparableStack(ModItems.thruster_large, 1), new OreDictStack("plateTitanium", 14), new OreDictStack(STEEL.plate(), 20), new OreDictStack("plateAluminum", 12), new ComparableStack(ModItems.circuit_targeting_tier3, 1), },350);
		makeRecipe(new ComparableStack(ModItems.warhead_volcano, 1), new AStack[] {new OreDictStack("plateTitanium", 24), new OreDictStack(STEEL.plate(), 16), new ComparableStack(ModBlocks.det_nuke, 3), new OreDictStack("blockUranium238", 24), new ComparableStack(ModItems.circuit_tantalium, 5) }, 600);
		
		makeRecipe(new ComparableStack(ModBlocks.machine_bat9000, 1), new AStack[] {new OreDictStack(STEEL.plate(), 16), new ComparableStack(ModItems.ingot_tcalloy, 16), new ComparableStack(ModBlocks.steel_scaffold, 16), new ComparableStack(ModItems.oil_tar, 16), },150);
		makeRecipe(new ComparableStack(ModBlocks.machine_orbus, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 12), new ComparableStack(ModItems.ingot_tcalloy, 12), new OreDictStack("plateSaturnite", 12), new ComparableStack(ModItems.coil_advanced_alloy, 12), new ComparableStack(ModItems.battery_sc_polonium, 1) }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.small_hatch, 1), new AStack[]{new OreDictStack(STEEL.plate(), 8), new OreDictStack("plateAdvancedAlloy", 2), new ComparableStack(ModItems.bolt_dura_steel, 1), new ComparableStack(ModBlocks.brick_concrete, 1), new ComparableStack(ModBlocks.ladder_red, 1)}, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.railgun_plasma, 1), new AStack[]{new OreDictStack(STEEL.plate(), 24), new ComparableStack(ModItems.hull_big_steel, 2), new ComparableStack(ModItems.hull_small_steel, 6), new ComparableStack(ModItems.pipes_steel, 2), new ComparableStack(ModBlocks.machine_lithium_battery, 4), new ComparableStack(ModItems.coil_copper, 16), new ComparableStack(ModItems.coil_copper_torus, 8), new ComparableStack(ModItems.plate_desh, 4), new ComparableStack(ModItems.circuit_targeting_tier4, 4), new ComparableStack(ModItems.circuit_targeting_tier3, 2), new OreDictStack("ingotPolymer", 4)}, 500);
