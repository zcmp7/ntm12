...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.thermo_unit_empty, 1), new AStack[] { new ComparableStack(ModItems.coil_copper_torus, 3), new OreDictStack("ingotSteel", 3), new OreDictStack("plateTitanium", 6), new ComparableStack(ModItems.plate_polymer, 12), new ComparableStack(ModItems.ingot_bromine, 2), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.pellet_schrabidium, 1), new AStack[] { new ComparableStack(ModItems.ingot_schrabidium, 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.pellet_lead, 1), new AStack[] { new OreDictStack("ingotLead", 5), new OreDictStack("plateIron", 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.fusion_conductor, 3), new AStack[] {new ComparableStack(ModItems.ingot_neodymium) , new OreDictStack("ingotSteel", 4), new ComparableStack(ModItems.coil_advanced_alloy, 10), }, 150);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_solinium, 1), new AStack[] { new ComparableStack(ModItems.plate_combine_steel, 6), new ComparableStack(ModItems.ingot_unobtainium, 3),  new ComparableStack(ModItems.coil_gold, 12), new ComparableStack(ModItems.solinium_propellant, 1), new ComparableStack(ModItems.solinium_igniter, 1), new ComparableStack(ModItems.solinium_core, 1), }, 400);
