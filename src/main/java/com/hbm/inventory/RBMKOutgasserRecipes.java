...
public class RBMKOutgasserRecipes {
	...
	public static void registerOverrides() {
		...
		RBMKOutgasserRecipes.setRecipe(200000, "ingotPu240", new ItemStack(ModItems.ingot_pu241));
		RBMKOutgasserRecipes.setRecipe(600000, "ingotPu241", new ItemStack(ModItems.ingot_am241));
		...
		RBMKOutgasserRecipes.setRecipe(5000, "ingotCobalt", new ItemStack(ModItems.ingot_co60));
		...
		RBMKOutgasserRecipes.setRecipe(900000, "dustLead", new ItemStack(ModItems.powder_pb209));
		RBMKOutgasserRecipes.setRecipe(18000, "ingotNiobium", new ItemStack(ModItems.ingot_technetium));
		RBMKOutgasserRecipes.setRecipe(25000, "blockU238", new ItemStack(ModItems.nugget_ra226));
		RBMKOutgasserRecipes.setRecipe(1000000, ModItems.powder_spark_mix, new ItemStack(ModItems.pellet_charged));
