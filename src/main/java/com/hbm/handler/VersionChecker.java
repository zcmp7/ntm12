...
public class VersionChecker {
	...
	public static void checkVersion() {
		...
		try {
			...
			//Drillgon200: Hopefully this'll work with my fork as well
			URL github = new URL("https://raw.githubusercontent.com/Drillgon200/Hbm-s-Nuclear-Tech-GIT/1.12.2_test/com/hbm/lib/RefStrings.java");
