...
public class RefStrings {
	...
	public static final String CHANGELOG = "§2Added: Cyclotron Automation, WasteLeaves, Recipe for hf_sword, hs_sword, Cobalt-60 billet\n§3Changed: Turret Gui, Crystal Recipes\n§6Fixed: Howard CWIS Range balance, Fusion Blanket Temp, AMS Limiter gui";
