...
public class RefStrings {
	...
	public static final String VERSION = "hbm-A-1.12.2-1.8.4c";
	public static final String CHANGELOG = "§2Added two new Meteorite Swords$§2Added JEI DFC support$§3Changed Meteorite Sword Guide Book$§3Changed Unobtainium Rod Balance$§6Fixed RBMK Rod Fuction Display$§6Fixed Hadron Coil Recipe Loop";
