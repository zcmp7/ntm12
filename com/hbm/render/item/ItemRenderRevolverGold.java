...
public class ItemRenderRevolverGold extends TEISRBase {

	protected ModelRevolver swordModel;
	protected ResourceLocation revolverLoc = new ResourceLocation(RefStrings.MODID +":textures/models/ModelRevolverGold.png");
