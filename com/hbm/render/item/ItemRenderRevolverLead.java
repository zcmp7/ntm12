...
public class ItemRenderRevolverLead extends TEISRBase {

	protected ModelRevolver swordModel;
	protected ResourceLocation revolverLoc = new ResourceLocation(RefStrings.MODID +":textures/models/ModelRevolverLead.png");
