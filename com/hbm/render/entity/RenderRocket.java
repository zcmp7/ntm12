...
public class RenderRocket extends Render<EntityBullet> {

	public static final IRenderFactory<EntityBullet> FACTORY = (RenderManager manager) -> {return new RenderRocket(manager);};
	
	private ModelBullet miniNuke;
	
	protected RenderRocket(RenderManager renderManager) {
		super(renderManager);
