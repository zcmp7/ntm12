...
public class EntityBulletBase extends Entity implements IProjectile {
        ...
        if (movement != null) {
        	...
        	//handle block collision
        		...
        		if(doesRic) {
                	...
                	case DOWN:
                		face = new Vec3d(0, -1, 0); break;
                	case UP:
                		face = new Vec3d(0, 1, 0); break;
                	case SOUTH:
                		face = new Vec3d(0, 0, 1); break;
                	case NORTH:
                		face = new Vec3d(0, 0, -1); break;
                	case WEST:
                		face = new Vec3d(-1, 0, 0); break;
                	case EAST:
                		face = new Vec3d(1, 0, 0); break;
                	}
	...
	private void onBlockImpact(BlockPos pos) {
		...
		if(config.incendiary > 0 && !this.world.isRemote) {
			if(world.rand.nextInt(3) == 0 && world.getBlockState(new BlockPos((int)posX, (int)posY, (int)posZ)).getBlock() == Blocks.AIR) world.setBlockState(new BlockPos((int)posX, (int)posY, (int)posZ), Blocks.FIRE.getDefaultState());
			if(world.rand.nextInt(3) == 0 && world.getBlockState(new BlockPos((int)posX + 1, (int)posY, (int)posZ)).getBlock() == Blocks.AIR) world.setBlockState(new BlockPos((int)posX + 1, (int)posY, (int)posZ), Blocks.FIRE.getDefaultState());
			if(world.rand.nextInt(3) == 0 && world.getBlockState(new BlockPos((int)posX - 1, (int)posY, (int)posZ)).getBlock() == Blocks.AIR) world.setBlockState(new BlockPos((int)posX - 1, (int)posY, (int)posZ), Blocks.FIRE.getDefaultState());
			if(world.rand.nextInt(3) == 0 && world.getBlockState(new BlockPos((int)posX, (int)posY + 1, (int)posZ)).getBlock() == Blocks.AIR) world.setBlockState(new BlockPos((int)posX, (int)posY + 1, (int)posZ), Blocks.FIRE.getDefaultState());
			if(world.rand.nextInt(3) == 0 && world.getBlockState(new BlockPos((int)posX, (int)posY - 1, (int)posZ)).getBlock() == Blocks.AIR) world.setBlockState(new BlockPos((int)posX, (int)posY - 1, (int)posZ), Blocks.FIRE.getDefaultState());
			if(world.rand.nextInt(3) == 0 && world.getBlockState(new BlockPos((int)posX, (int)posY, (int)posZ + 1)).getBlock() == Blocks.AIR) world.setBlockState(new BlockPos((int)posX, (int)posY, (int)posZ + 1), Blocks.FIRE.getDefaultState());
			if(world.rand.nextInt(3) == 0 && world.getBlockState(new BlockPos((int)posX, (int)posY, (int)posZ - 1)).getBlock() == Blocks.AIR) world.setBlockState(new BlockPos((int)posX, (int)posY, (int)posZ - 1), Blocks.FIRE.getDefaultState());
		}
	...
	private void onRicochet(BlockPos pos) {
		...
		if(!world.isRemote && config.destroysWood &&
				(m == Material.WOOD ||
				m == Material.PLANTS ||
				m == Material.GLASS ||
				m == Material.LEAVES))
