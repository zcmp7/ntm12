...
public class BulletConfigSyncingUtil {
	...
	private static List<ConfigKeyPair> configSet = new ArrayList<ConfigKeyPair>();
	
	/// it's like a hashmap, but easier ///
	//Drillgon200: More like it's like a hashmap, but without the efficiency, and actually slightly harder to use.
