...
public class BobmazonOfferFactory {
	...
	public static void init() {
		...
		special.add(new Offer(new ItemStack(ModItems.nuke_starter_kit), Requirement.HIDDEN, 200));
		special.add(new Offer(new ItemStack(ModItems.nuke_advanced_kit), Requirement.HIDDEN, 300));
		special.add(new Offer(new ItemStack(ModItems.boy_kit), Requirement.HIDDEN, 350));
		special.add(new Offer(new ItemStack(ModItems.gun_lever_action), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModItems.ammo_20gauge, 24), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModItems.ammo_20gauge_incendiary, 24), Requirement.HIDDEN, 15));
		special.add(new Offer(new ItemStack(ModItems.gun_uzi_silencer, 1), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModItems.ammo_22lr, 64), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModItems.ammo_22lr_ap, 64), Requirement.HIDDEN, 15));
		special.add(new Offer(new ItemStack(ModItems.gun_hk69, 24), Requirement.HIDDEN, 30));
		special.add(new Offer(new ItemStack(ModItems.ammo_grenade, 6), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModItems.ammo_grenade_sleek, 6), Requirement.HIDDEN, 40));
		special.add(new Offer(new ItemStack(ModItems.gun_kit_1, 10), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModItems.gun_kit_2, 5), Requirement.HIDDEN, 15));
		special.add(new Offer(new ItemStack(ModBlocks.machine_epress, 2), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModBlocks.machine_assembler, 1), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModBlocks.machine_chemplant, 1), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModBlocks.machine_boiler_off, 1), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModBlocks.machine_well, 1), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModBlocks.machine_refinery, 1), Requirement.HIDDEN, 25));
		special.add(new Offer(new ItemStack(ModBlocks.machine_fluidtank, 4), Requirement.HIDDEN, 10));
		special.add(new Offer(new ItemStack(ModItems.ingot_steel, 64), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModItems.ingot_copper, 64), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModItems.ingot_red_copper, 64), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModItems.ingot_titanium, 64), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModItems.ingot_tungsten, 64), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModBlocks.struct_launcher_core, 1), Requirement.HIDDEN, 30));
		special.add(new Offer(new ItemStack(ModBlocks.struct_launcher_core_large, 1), Requirement.HIDDEN, 30));
		special.add(new Offer(new ItemStack(ModBlocks.struct_launcher, 40), Requirement.HIDDEN, 20));
		special.add(new Offer(new ItemStack(ModBlocks.struct_scaffold, 11), Requirement.HIDDEN, 5));
		special.add(new Offer(new ItemStack(ModItems.loot_10, 1), Requirement.HIDDEN, 5));
		special.add(new Offer(new ItemStack(ModItems.loot_15, 1), Requirement.HIDDEN, 5));
		special.add(new Offer(new ItemStack(ModItems.loot_misc, 1), Requirement.HIDDEN, 5));
		special.add(new Offer(new ItemStack(ModBlocks.crate_can, 1), Requirement.HIDDEN, 2));
	}
