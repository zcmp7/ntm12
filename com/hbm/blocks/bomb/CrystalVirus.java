...
public class CrystalVirus extends Block {
	...
	public void neighborChanged(IBlockState state, World world, BlockPos pos1, Block blockIn, BlockPos fromPos) {
		...
		int z = pos1.getZ();
		MutableBlockPos pos = new BlockPos.MutableBlockPos();
		if((world.getBlockState(pos.setPos(x + 1, y, z)).getBlock() == Blocks.AIR || world.getBlockState(pos.setPos(x + 1, y, z)).getBlock() == ModBlocks.crystal_virus || world.getBlockState(pos.setPos(x + 1, y, z)).getBlock() == ModBlocks.crystal_hardened || world.getBlockState(pos.setPos(x + 1, y, z)).getBlock() == ModBlocks.crystal_pulsar) && 
    			(world.getBlockState(pos.setPos(x - 1, y, z)).getBlock() == Blocks.AIR || world.getBlockState(pos.setPos(x - 1, y, z)).getBlock() == ModBlocks.crystal_virus || world.getBlockState(pos.setPos(x - 1, y, z)).getBlock() == ModBlocks.crystal_hardened || world.getBlockState(pos.setPos(x - 1, y, z)).getBlock() == ModBlocks.crystal_pulsar) && 
    			(world.getBlockState(pos.setPos(x, y + 1, z)).getBlock() == Blocks.AIR || world.getBlockState(pos.setPos(x, y + 1, z)).getBlock() == ModBlocks.crystal_virus || world.getBlockState(pos.setPos(x, y + 1, z)).getBlock() == ModBlocks.crystal_hardened || world.getBlockState(pos.setPos(x, y + 1, z)).getBlock() == ModBlocks.crystal_pulsar) && 
    			(world.getBlockState(pos.setPos(x, y - 1, z)).getBlock() == Blocks.AIR || world.getBlockState(pos.setPos(x, y - 1, z)).getBlock() == ModBlocks.crystal_virus || world.getBlockState(pos.setPos(x, y - 1, z)).getBlock() == ModBlocks.crystal_hardened || world.getBlockState(pos.setPos(x, y - 1, z)).getBlock() == ModBlocks.crystal_pulsar) && 
    			(world.getBlockState(pos.setPos(x, y, z + 1)).getBlock() == Blocks.AIR || world.getBlockState(pos.setPos(x, y, z + 1)).getBlock() == ModBlocks.crystal_virus || world.getBlockState(pos.setPos(x, y, z + 1)).getBlock() == ModBlocks.crystal_hardened || world.getBlockState(pos.setPos(x, y, z + 1)).getBlock() == ModBlocks.crystal_pulsar) && 
    			(world.getBlockState(pos.setPos(x, y, z - 1)).getBlock() == Blocks.AIR || world.getBlockState(pos.setPos(x, y, z - 1)).getBlock() == ModBlocks.crystal_virus || world.getBlockState(pos.setPos(x, y, z - 1)).getBlock() == ModBlocks.crystal_hardened || world.getBlockState(pos.setPos(x, y, z - 1)).getBlock() == ModBlocks.crystal_pulsar) && 
    			!world.isRemote) {
			world.setBlockState(pos.setPos(x, y, z), ModBlocks.crystal_hardened.getDefaultState());
    	}
