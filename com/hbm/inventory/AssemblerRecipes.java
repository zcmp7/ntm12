...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.tritium_deuterium_cake, 1), new AStack[] {new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.deuterium, 6)), new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.tritium, 2)), new ComparableStack(ModItems.lithium, 4), },100);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_plasma, 2), new AStack[] {new OreDictStack("plateSteel", 3), new ComparableStack(ModItems.plate_advanced_alloy, 1), new ComparableStack(ModItems.coil_advanced_torus, 1), new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.deuterium)), new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.tritium)), },100);
		...
		makeRecipe(new ComparableStack(ModItems.mike_deut, 1), new AStack[] {new OreDictStack("plateIron", 12), new OreDictStack("plateSteel", 16), new NbtComparableStack(ItemCell.getFullCell(ModForgeFluids.deuterium, 10)), },100);
