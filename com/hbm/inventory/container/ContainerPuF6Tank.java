...
public class ContainerPuF6Tank extends Container {
	...
	public ContainerPuF6Tank(InventoryPlayer invPlayer, TileEntityMachinePuF6Tank tedf) {
		...
		this.addSlotToContainer(new SlotMachineOutput(invPlayer.player, tedf.inventory, 1, 44, 53));
		this.addSlotToContainer(new SlotItemHandler(tedf.inventory, 2, 116, 17));
		this.addSlotToContainer(new SlotMachineOutput(invPlayer.player, tedf.inventory, 3, 116, 53));
